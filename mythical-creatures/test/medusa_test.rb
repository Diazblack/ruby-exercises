...
class MedusaTest < Minitest::Test
  ...
  def test_can_only_have_three_victims
    ...
    victim_2 = Person.new("Manseus")
    victim_3 = Person.new("Maximus")
    victim_4 = Person.new("Minimus")
    victim_5 = Person.new("Zarebok")
    victim_6 = Person.new("Balgruf")
    ...
    medusa.stare(victim_6)

    assert_equal false,  victim_1.stoned?
    assert_equal false,  victim_2.stoned?
    assert_equal false,  victim_3.stoned?
  end
